 ...
 * hand-laid polylines on a 0..4 x, 0..6 y grid (y up). Ported from the suite's
 * GL games so the workout HUD glows in the same vector style as the coach.
 */
object StrokeFont {
    ...
    private val LETTERS: Map<Char, Array<IntArray>> = mapOf(
        ...
        '~' to arrayOf(intArrayOf(0, 3, 1, 4, 3, 2, 4, 3)),
        '^' to arrayOf(intArrayOf(1, 4, 2, 6, 3, 4)),
    )
